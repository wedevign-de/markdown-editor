export const base = {
  ...
  articleSet: "Lesson",
  searchOrPasteArticleSetLink: "Search lesson or paste a link…",
  findOrCreateArticleSet: "Find or create an lesson…",
  createNewArticleSet: "Create a new lesson",
  articleProgression: "Course",
  searchOrPasteArticleProgressionLink: "Search course or paste a link…",
  findOrCreateArticleProgression: "Find or create a course…",
  createNewArticleProgression: "Create a new course",
  exercise: "Exercise",
  searchOrPasteExerciseLink: "Search article or paste a link…",
  findOrCreateExercise: "Find or create an article…",
  createNewExercise: "Create a new article",
